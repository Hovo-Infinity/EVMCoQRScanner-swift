...
@class TagInfo;
/**
 Abstract class <code>AbstractDataModel</code> is the root of Data hierarchy, containing the basic common functions applicable to all Data classes. All Data classes will have <code>AbstractDataModel</code> as its superclass.
 */
...
/**
 ...
 @return Value if found else `nil`
  ...
  @note All the values are of `String` type except value for additional data `PPTag.TAG_62_ADDITIONAL_DATA_FIELD` for which the returned type would be `AdditionalData`
 */
...
/**
 ...
 @note Throws: `MPQRError.missingTag` if the value for tag info is **not** present while the tag was **mandatory**. Throws: `MPQRError.invalidTagValue` If the value doesn't match pattern of the tag. And if the length of string representation of the value is out of [1, 99] range
 */
